    ...
    <div>
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <Baby className="w-16 h-16 text-primary-500 mx-auto mb-6" />
            ...
            {sessionTypes.map((session, index) => (
              ...
              >
                <div className={index % 2 === 1 ? 'md:order-2' : ''}>
                  ...
                  <p className="text-light-700 text-lg mb-6">{session.description}</p>
                  <ul className="space-y-3">
                    {session.details.map((detail, i) => (
                      <li key={i} className="flex items-center space-x-3">
                        <Check className="w-5 h-5 text-primary-500 flex-shrink-0" />
                        <span className="text-light-600">{detail}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                ...
                <div className={index % 2 === 1 ? 'md:order-1' : ''}>
                  <div className="relative">
                    ...
                    />
                    <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-primary-500/10 rounded-2xl -z-10"></div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 px-4 bg-light-100">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <Sun className="w-12 h-12 text-primary-500 mb-4" />
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-light-700">Soft, flattering lighting</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Heart className="w-6 h-6 text-primary-500" />
                  <span className="text-light-700">Comfortable, relaxed environment</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Heart className="w-6 h-6 text-primary-500" />
                  <span className="text-light-700">Professional yet personal approach</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-light-600">Complete care for your comfort and memories</p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-light-600 mb-8">
            Let XYZ Studio document this precious chapter of your life with care and artistry.
          </p>
