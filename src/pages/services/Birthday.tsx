    ...
    <div>
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <Cake className="w-16 h-16 text-amber-500 mx-auto mb-6 animate-bounce" />
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zinc-400">Perfect for every age and celebration style</p>
          </div>
            ...
            {themes.map((theme, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  ...
                  <p className="text-zinc-300">{theme.description}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-zinc-300">Custom backdrop setups</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Gift className="w-6 h-6 text-amber-500" />
                  <span className="text-zinc-300">Props and accessories included</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Gift className="w-6 h-6 text-amber-500" />
                  <span className="text-zinc-300">Themed photography concepts</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Gift className="w-6 h-6 text-amber-500" />
                  <span className="text-zinc-300">Cake smash sessions available</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zinc-400">Everything you need for a memorable celebration</p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-zinc-400 mb-8">
            ...
            shoot with Offtbeat Studio today!
          </p>
